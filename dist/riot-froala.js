...
},{"./../node_modules/cssify":16}],2:[function(require,module,exports){
...
},{"./riot-froala":19,"riot":18}],10:[function(require,module,exports){
/*!
 * froala_editor v2.0.5 (https://www.froala.com/wysiwyg-editor)
 * License https://froala.com/wysiwyg-editor/terms
 * Copyright 2014-2015 Froala Labs
 ...
 ',
    function(opts) {
        ...
        this.init = function() {
            ...
            require('./css/froala_editor.min.css');

            // Plugins
            require('./lib/plugins/lists.min');
            require('./lib/plugins/video.min');
            require('./lib/plugins/image.min');
            require('./lib/plugins/link.min');
            require('./lib/plugins/paragraph_format.min');
            require('./css/plugins/file.min.css');
            require('./css/plugins/image.min.css');
            require('./css/plugins/video.min.css');
            //require('./lib/plugins/paragraph_style.min');

            // Themes
            require('./css/themes/dark.min.css');
            require('./css/themes/gray.min.css');
            require('./css/themes/red.min.css');
            require('./css/themes/royal.min.css');
            ...
            if (opts['buttons']) {
                options.toolbarButtons = opts['buttons'].split(/\s+/);
            }
            if (opts['block-tags']) {
...
},{"./css/froala_editor.min.css":1,"./css/plugins/file.min.css":2,"./css/plugins/image.min.css":3,"./css/plugins/video.min.css":4,"./css/themes/dark.min.css":5,"./css/themes/gray.min.css":6,"./css/themes/red.min.css":7,"./css/themes/royal.min.css":8,"./lib/froala_editor.min":10,"./lib/plugins/image.min":11,"./lib/plugins/link.min":12,"./lib/plugins/lists.min":13,"./lib/plugins/paragraph_format.min":14,"./lib/plugins/video.min":15,"jquery":17}]},{},[9]);
